...
export default function Page() {
  ...
  // Novos Estados para Upsell/Downsell (Substituindo Frequência)
  ...
  const calcular = () => {
    ...
    // Lógica LTV baseada em Upsell/Downsell

    let multiplicadorLTV = 1

    if (temUpsell) multiplicadorLTV += 0.2 // +20% se tiver Upsell

    if (temDownsell) multiplicadorLTV += 0.1 // +10% se tiver Downsell
              ...
              <>
                ...
                <div>
                    ...
                    <label className="flex items-center justify-center md:justify-start gap-2 text-[#7ef542] text-sm mb-2">
                      ...
                      <TrendingUp className="w-4 h-4" /> Tem Upsell?
                ...
                <div>
                    ...
                    <label className="flex items-center justify-center md:justify-start gap-2 text-[#7ef542] text-sm mb-2">
                      ...
                      <TrendingUp className="w-4 h-4 rotate-180" /> Tem Downsell?
              ...
              <div className="bg-black/30 p-4 rounded-lg border border-yellow-500/20 mt-2">
                ...
                <ul className="space-y-1 text-[11px] text-gray-400 list-none">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-red-400 font-bold">Crítico (&lt; 30%):</span> Vazamento grave. Seu lucro
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    paga pelo lead, mas ele desiste na boca do gol.
              ...
              <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-6">
                ...
                <div className="text-center md:text-left">
                  ...
                  {resultados.desperdicioTrafego > 0 && (
                    ...
                    <div className="mt-4 bg-red-900/20 border border-red-500/30 p-4 rounded-lg inline-block text-left w-full">

                      <div className="flex items-center gap-2 text-red-400 mb-2 font-bold text-sm">

                        <Target className="w-4 h-4" /> Capital de Tráfego Subutilizado
                      ...
                      <p className="text-xs text-gray-300 leading-relaxed">
                        ...
                        Sua operação apresenta uma <strong>ineficiência técnica de {resultados.ineficienciaTrafego.toFixed(1).replace('.', ',')}%</strong>.

                        <br /><br />

                        Isso significa que sua taxa de conversão atual ({resultados.taxaConversaoAtual.toFixed(2).replace('.', ',')}%) obriga você a comprar muito mais tráfego do que o necessário para bater suas metas. Você está pagando um "ágio" caro por cada venda.

                        <br /><br />

                        <span className="block border-t border-red-500/30 pt-2 text-red-300 font-semibold">

                          📉 Diagnóstico Financeiro: Você queimou {formatResultCurrency(resultados.desperdicioTrafego)} este mês apenas para compensar a fricção do seu checkout.
