            ...
            <div className="mt-6 bg-[#111816] rounded-2xl p-8 border border-yellow-600/30 text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 mb-4">
                ...
                <h4 className="text-lg font-bold text-yellow-500">
                  Diagnóstico de Mercado: Como sua operação se compara aos grandes players.
                </h4>
              </div>

              <div className="space-y-6 text-sm text-gray-300">
                <p className="text-gray-400 text-xs">
                  Utilizamos inteligência de dados dos maiores infoprodutores do Brasil (2024/2025) para tickets de até R$ 1.000,00.
                </p>
                ...
                <ul className="space-y-2 list-disc list-inside text-gray-400 text-xs">
                  ...
                  <li>
                    Margem de Segurança: Aplicamos uma métrica real de{" "}
                    <span className="text-[#7ef542] font-semibold">3 abandonos para cada 1 venda</span>, garantindo que este diagnóstico seja pé no chão e altamente realista.
                  </li>
                </ul>
              </div>
          ...
          {modoDetalhado && (
            <div className="mt-6 bg-[#111816] rounded-2xl p-8 border border-yellow-600/30 text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 mb-4">
                <AlertTriangle className="w-5 h-5 text-yellow-500 flex-shrink-0 mt-1" />
                <h4 className="text-lg font-bold text-yellow-500">
                  Diagnóstico de Precisão: Baseado 100% nos seus números reais.
                </h4>
              </div>
              <div className="space-y-6 text-sm text-gray-300">
                <p className="text-gray-400 text-xs">
                  Abaixo, apresentamos a realidade matemática da sua operação. Cruzamos seu faturamento e taxa de conversão para revelar o gargalo exato do seu funil
                </p>
                ...
                <div className="bg-black/30 p-4 rounded-lg border border-yellow-500/20 mt-2">
                  ...
                  <ul className="space-y-1 text-[11px] text-gray-400 list-none">
                    ...
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-yellow-500"></span>{" "}
                      <span className="text-yellow-400 font-bold">Padrão (30% - 60%):</span> Zona de estagnação. Você paga pelo lead, mas ele desiste na "cara" do gol.
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-[#7ef542]"></span>{" "}
